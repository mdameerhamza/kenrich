...
function get_contact_permissions()
{
    $permissions = array(
            array(
                'id' => 1,
                'name' => _l('customer_permission_lifestyle'),
                'short_name' => 'lifestyle',
            ),
            array(
                'id' => 2,
                'name' => _l('customer_permission_ovulation'),
                'short_name' => 'ovulation',
            ),
            array(
                'id' => 3,
                'name' => _l('customer_permission_barness_test'),
                'short_name' => 'barness_test',
            ),
            array(
                'id' => 4,
                'name' => _l('customer_permission_hormone_analyse'),
                'short_name' => 'hormone_analyse',
            ),
            array(
                'id' => 5,
                'name' => _l('customer_permission_food_nutrition'),
                'short_name' => 'support',
            ),
            array(
                'id' => 6,
                'name' => _l('customer_permission_stress_management'),
                'short_name' => 'stress_management',
            ),
        );
