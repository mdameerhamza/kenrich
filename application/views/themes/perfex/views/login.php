<div class="">
	<div class="col-md-4 col-md-offset-4 text-center login-logo">
	...
	<div class="col-md-4 col-md-offset-4">
		...
		<div class="form-group">
			<button type="submit" class="btn btn-info btn-block btn-login"><?php echo _l('clients_login_login_string'); ?></button>
