...
class Emails extends Admin_controller
{
    ...
    public function sent_smtp_test_email()
    {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom(get_option("smtp_email"), get_option("smtp_username"));
            $mail->addAddress($this->input->post('test_email'), '');     // Add a recipient
            ...
            set_alert('success', 'Seems like your SMTP settings is set correctly. Check your email now.');
                do_action('smtp_test_email_success');
                 ...
                 set_debug_alert('<h1>Your SMTP settings are not set correctly here is the debug log.</h1><br />' . $mail->ErrorInfo);
